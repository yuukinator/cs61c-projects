...
void disassemble(inst_t inst)
{
  ...
  switch (inst.rtype.opcode)
	  ...
	  printf("beq\t$%d,$%d,%d\n", inst.itype.rs,
		 inst.itype.rt, (int32_t) (int16_t) inst.itype.imm*4);
	  break;
	 ...
	 printf("bne\t$%d,$%d,%d\n", inst.itype.rs,
	  ...
	  printf("addiu\t$%d,$%d,%d\n", inst.itype.rt,
		 inst.itype.rs, (int32_t) (int16_t)  inst.itype.imm);
	  break;
	  ...
	  printf("lb\t$%d,%d($%d)\n", inst.itype.rt,
		 (int32_t) (int16_t) inst.itype.imm, inst.itype.rs);
	  break;
